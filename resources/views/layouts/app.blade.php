...
<head>
    ...
    <link href="{{ url('/stylesheets/typography.css') }}" rel="stylesheet">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="{{ url('/images/laravel.ico') }}"
...
@else
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/audiojs/1.0.1/audio.cmd.min.js"></script>
    @yield('scripts')
</body>
</html>